...
Purpose:
This script runs the main business analysis for the DVD Rental project.
...
# Use total revenue as the customer's historical value.
...
# Churn risk scoring
# Customers with older last payment dates are treated as higher risk.
...
# Customer behaviour patterns
# Group customers based on how often they rented.

customer_df["activity_group"] = pd.qcut(
customer_df["total_rentals"].rank(method="first"),
q=3,
...
# Check how revenue changes by month.
...
# Compare categories using revenue, rentals, and payment values.
...
# Pricing insight
# Check revenue per rental for each film.
...
# Store performance
# Compare the two stores using revenue and inventory efficiency.
...
# Find film copies with the lowest rental activity.
...
# Simple recommendation analysis
# Pick strong categories for basic recommendations.
...
Total Rentals: {top_activity_group["total_rentals"]}

This shows that rental frequency is a useful behaviour to track when planning
repeat rental campaigns.
